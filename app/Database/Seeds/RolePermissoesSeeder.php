...
{
    private const MAPA = [
        'administrador' => ['dashboard:visualizar', 'usuarios:*', 'roles:*', 'igreja:visualizar', 'igreja:editar', 'banners:*', 'congregacoes:*', 'membros:*', 'visitantes:*', 'obreiros:*', 'departamentos:*', 'ministerios:*', 'celulas:*', 'discipulados:*', 'cursos:*', 'carteirinhas:*', 'cargos:*', 'diretorias:*', 'financeiro:*', 'relatorios:*'],
        'pastor'        => ['dashboard:visualizar', 'igreja:visualizar', 'banners:visualizar', 'congregacoes:visualizar', 'congregacoes:cadastrar', 'congregacoes:editar', 'membros:visualizar', 'membros:cadastrar', 'membros:editar', 'visitantes:visualizar', 'visitantes:cadastrar', 'obreiros:visualizar', 'obreiros:cadastrar', 'departamentos:visualizar', 'departamentos:cadastrar', 'departamentos:editar', 'ministerios:visualizar', 'ministerios:cadastrar', 'ministerios:editar', 'celulas:visualizar', 'celulas:cadastrar', 'celulas:editar', 'discipulados:visualizar', 'discipulados:cadastrar', 'discipulados:editar', 'cursos:visualizar', 'cursos:cadastrar', 'cursos:editar', 'carteirinhas:visualizar', 'carteirinhas:imprimir', 'diretorias:visualizar', 'diretorias:cadastrar', 'diretorias:editar', 'relatorios:visualizar', 'relatorios:imprimir'],
