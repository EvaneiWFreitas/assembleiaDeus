...
<h4 class="fw-bold mb-3">
    <i class="fa-solid fa-box-open me-2 text-primary"></i><?= esc($registro ? 'Editar Oferta' : 'Nova Oferta') ?>
</h4>

<div class="card border-0 shadow-sm">
    <div class="card-body">
        <?= form_open($registro ? 'ofertas/atualizar/' . $registro['id'] : 'ofertas/salvar') ?>
            <div class="row g-3">
                <div class="col-md-4">
            ...
            <div class="mt-4 d-flex gap-2">
                ...
                <a href="<?= site_url('ofertas') ?>" class="btn btn-secondary">Cancelar</a>
            </div>
        <?= form_close() ?>
    </div>
</div>
