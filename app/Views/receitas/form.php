...
<h4 class="fw-bold mb-3">
    <i class="fa-solid fa-money-check-dollar me-2 text-success"></i><?= esc($registro ? 'Editar Receita' : 'Nova Receita') ?>
</h4>

<div class="card border-0 shadow-sm">
    <div class="card-body">
        <?= form_open($registro ? 'receitas/atualizar/' . $registro['id'] : 'receitas/salvar') ?>
            <div class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="descricao" name="descricao" class="form-control" required
                        value="<?= old('descricao', esc($registro['descricao'] ?? '')) ?>" maxlength="191">
                </div>
                <div class="col-md-4">
            ...
            <div class="mt-4 d-flex gap-2">
                ...
                <a href="<?= site_url('receitas') ?>" class="btn btn-secondary">Cancelar</a>
            </div>
        <?= form_close() ?>
    </div>
</div>
